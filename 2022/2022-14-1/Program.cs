...
namespace MyApp
{
    internal class Program
    {
        ...
        {
            for (var i = 0; i < 500; i++) {
                Locations.Add(Enumerable.Repeat('.', 550).ToList());
            }
        ...
        private static bool TryAddSand() {
            ...
            while (true) {
                if (newSandPosition.Item2 == VoidLevel) {
                    return false;
                } else if (newSandPosition.Item2 == oldSandPosition.Item2 && newSandPosition.Item1 == oldSandPosition.Item1){
